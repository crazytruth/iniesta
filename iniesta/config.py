...
INIESTA_SQS_RECEIVE_MESSAGE_MAX_NUMBER_OF_MESSAGES = (
    10  # values needs to be 0-10
)
INIESTA_SQS_RECEIVE_MESSAGE_WAIT_TIME_SECONDS = (
    20  # needs to be a value between 0-20 (0 for short polling)
)
...
# INIESTA_SQS_REGION_NAME = 'us-east-1'
INIESTA_SQS_REGION_NAME = None
INIESTA_SQS_ENDPOINT_URL = None
# INIESTA_SNS_REGION_NAME = 'us-east-1'
INIESTA_SNS_REGION_NAME = None
